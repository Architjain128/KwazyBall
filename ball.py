        ...
        if(self.speedy2 < 0):
            if(self.speedx2 > 0):
                ...
                if(t%5==3 ):
                    ...
                    flup = False
                    flss = False
                    if((self.y2 <=15 and self.y2 >= 10) and ((t>=8 and t<73) and ( check_buddy(self.y2-10) and (archit[self.y2-10][(t-4)//5]!=0)))):
                        flss = True
                    if((self.y2 <=16 and self.y2 >= 11) and ((t>8 and t<=73) and ( check_buddy(self.y2-11) and (archit[self.y2-11][((t-4)//5)-1]!=0)))):
                        flup = True
            
                    if(flss==True and flup==True):
                        if(archit[self.y2-10][(t-4)//5] != 10):
                            if(archit[self.y2-10][(t-4)//5] == -1):
                                sscore.update_val( self.chickibum(self.y2-10,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-10][(t-4)//5])
                                    archit[self.y2-10][(t-4)//5]=0
                                else:
                                    archit[self.y2-10][(t-4)//5]=archit[self.y2-10][(t-4)//5]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-10][(t-4)//5]==0 and archit_power[self.y2-10][(t-4)//5]!=0):
                                    powers.append(Power((t-4)//5,self.y2-10,archit_power[self.y2-10][(t-4)//5],cclock.return_val()))
                                
                        if(archit[self.y2-11][((t-4)//5)-1] != 10):
                            if(archit[self.y2-11][((t-4)//5)-1] == -1):
                                sscore.update_val( self.chickibum(self.y2-11,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-11][((t-4)//5)-1] )
                                    archit[self.y2-11][((t-4)//5)-1] =0
                                else:
                                    archit[self.y2-11][((t-4)//5)-1] = archit[self.y2-11][((t-4)//5)-1]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-11][((t-4)//5)-1]==0 and archit_power[self.y2-11][((t-4)//5)-1]!=0):
                                    powers.append(Power(((t-4)//5)-1,self.y2-11,archit_power[self.y2-11][((t-4)//5)-1],cclock.return_val()))
                        if(self.thruball == False):
                            self.speedx2 = -1 * self.speedx2
                            self.speedy2 = -1 * self.speedy2
                    elif(flss == True):
                        ...
                        if( (((((t-4)//5)+1)<= 12) and ((((t-4)//5)+1) >= 0)) and  (check_buddy(self.y2-11) and  (archit[self.y2-11][((t-4)//5)]!=0)) ):
                            if(archit[self.y2-11][((t-4)//5)]!=10):
                                if(archit[self.y2-11][(t-4)//5] == -1):
                                    sscore.update_val( self.chickibum(self.y2-11,archit))
                                else:
                                    if(self.thruball==True):
                                        sscore.update_val(archit[self.y2-11][((t-4)//5)] )
                                        archit[self.y2-11][((t-4)//5)] =0
                                    else:
                                        archit[self.y2-11][((t-4)//5)] = archit[self.y2-11][((t-4)//5)] -1
                                        sscore.update_val(1)
                                    if(archit[self.y2-11][(t-4)//5]==0 and archit_power[self.y2-11][(t-4)//5]!=0):
                                        powers.append(Power((t-4)//5,self.y2-11,archit_power[self.y2-11][(t-4)//5],cclock.return_val()))
                            if(self.thruball == False):
                                self.speedx2 = -1 * self.speedx2
                                self.speedy2 = -1 * self.speedy2
                else:
                    if((self.y2 <=16 and self.y2 >= 11) and ((t>8 and t<73) and (archit[self.y2-11][(t-9)//5]!=0))):
                        if(archit[self.y2-11][(t-9)//5]!=10):
                            if(archit[self.y2-11][(t-4)//5] == -1):
                                sscore.update_val( self.chickibum(self.y2-11,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-11][((t-9)//5)] )
                                    archit[self.y2-11][((t-9)//5)] =0
                                else:
                                    archit[self.y2-11][(t-9)//5] = archit[self.y2-11][(t-9)//5]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-11][(t-9)//5]==0 and archit_power[self.y2-11][(t-9)//5]!=0):
                                    powers.append(Power((t-9)//5,self.y2-11,archit_power[self.y2-11][(t-9)//5],cclock.return_val()))
                        if(self.thruball == False):
                            self.speedy2 = -1 * self.speedy2
                ...
                if(t%5==4 and t>9):
                    fldw = False
                    flss = False
                    if((self.y2 <=15 and self.y2 >= 10) and ((t>9 and t<=74) and ( check_buddy(self.y2-10) and (archit[self.y2-10][((t-14)//5)]!=0)))):
                        flss = True
                    if((self.y2 <=16 and self.y2 >= 11) and ((t>= 9 and t<=69) and ( check_buddy(self.y2-11) and (archit[self.y2-11][(t-9)//5]!=0)))):
                        fldw = True
                    
                    if(flss==True and fldw==True):
                        if(archit[self.y2-10][((t-14)//5)]!=10):
                            if(archit[self.y2-10][((t-14)//5)] == -1):
                                sscore.update_val( self.chickibum(self.y2-10,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-10][((t-14)//5)] )
                                    archit[self.y2-10][((t-14)//5)] =0
                                else:
                                    archit[self.y2-10][((t-14)//5)]=archit[self.y2-10][((t-14)//5)]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-10][(t-4)//5]==0 and archit_power[self.y2-10][(t-4)//5]!=0):
                                    powers.append(Power((t-4)//5,self.y2-10,archit_power[self.y2-10][(t-4)//5],cclock.return_val()))
                        ...
                        if(archit[self.y2-11][(t-9)//5]!=10):
                            if(archit[self.y2-11][(t-9)//5] == -1):
                                ...
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-11][((t-9)//5)-1] )
                                    archit[self.y2-11][((t-9)//5)-1] =0
                                else:
                                    archit[self.y2-11][(t-9)//5] = archit[self.y2-11][(t-9)//5]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-11][(t-9)//5]==0 and archit_power[self.y2-11][(t-9)//5]!=0):
                        ...
                        if(archit[self.y2-10][((t-14)//5)]!=10):
                            if(archit[self.y2-10][((t-14)//5)] == -1):
                                ...
                                if(self.thruball==True):
                                    ...
                                    archit[self.y2-10][((t-14)//5)]=archit[self.y2-10][((t-14)//5)]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-10][((t-14)//5)]==0 and archit_power[self.y2-10][((t-14)//5)]!=0):
                                    powers.append(Power(((t-14)//5),self.y2-10,archit_power[self.y2-10][((t-14)//5)],cclock.return_val()))
                        if(self.thruball == False):
                            self.speedx2 = -1 * self.speedx2
                    elif(fldw == True):
                        if(archit[self.y2-11][(t-9)//5] != 10):
                        ...
                        if(( ((((t-4)//5)-1)>=0) and ((((t-4)//5)-1)<=12) ) and ( check_buddy(self.y2-11) and (archit[self.y2-11][((t-4)//5)-1]!=0)) ):
                            if(archit[self.y2-11][((t-4)//5)-1]!=10):
                                if(archit[self.y2-11][((t-4)//5)-1] == -1):
                                    sscore.update_val( self.chickibum(self.y2-11,archit))
                                else:
                                    if(self.thruball==True):
                                        ...
                                        sscore.update_val(1)
                                    if(archit[self.y2-11][((t-4)//5)-1]==0 and archit_power[self.y2-11][((t-4)//5)-1]!=0):
                                        powers.append(Power(((t-4)//5)-1,self.y2-11,archit_power[self.y2-11][((t-14)//5)-1],cclock.return_val()))
                            if(self.thruball == False):
                                self.speedx2 = -1 * self.speedx2
                                self.speedy2 = -1 * self.speedy2
                else:
                    if( (self.y2>=11 and self.y2<=16) and ( (t>8 and t<73) and ( check_buddy(self.y2-11) and (archit[self.y2-11][(t-9)//5]!=0)))):
                        if(archit[self.y2-11][(t-9)//5]!=10):
                            if(archit[self.y2-11][(t-9)//5] == -1):
                                sscore.update_val( self.chickibum(self.y2-11,archit))
                            else:
            ...
            if(self.speedx2 > 0):
                ...
                if(t%5==3 ):
                    ...
                    if((self.y2 <=15 and self.y2 >= 10) and ((t>=8 and t<73) and ( check_buddy(self.y2-10) and archit[self.y2-10][(t-4)//5]!=0))):
                        flss = True
                    if((self.y2 <=14 and self.y2 >= 9) and ((t>8 and t<=73) and ( check_buddy(self.y2-9) and archit[self.y2-9][((t-4)//5)-1]!=0))):
                        flup = True
                    print(flss, flup)
                    if(flss==True and flup==True):
                        if(archit[self.y2-10][(t-4)//5]!=10):
                            if(archit[self.y2-10][(t-4)//5] == -1):
                                ...
                                if(archit[self.y2-10][((t-4)//5)]==0 and archit_power[self.y2-10][((t-4)//5)]!=0):
                                    powers.append(Power(((t-4)//5),self.y2-10,archit_power[self.y2-10][((t-4)//5)],cclock.return_val()))
                        if(archit[self.y2-9][((t-4)//5)-1]!=10):
                            if(archit[self.y2-9][((t-4)//5)-1] == -1):
                                sscore.update_val( self.chickibum(self.y2-9,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-9][((t-4)//5)-1] )
                                    archit[self.y2-9][((t-4)//5)-1] =0
                                else:
                                    archit[self.y2-9][((t-4)//5)-1] = archit[self.y2-9][((t-4)//5)-1]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-9][((t-4)//5)-1]==0 and archit_power[self.y2-9][((t-4)//5)-1]!=0):
                                    powers.append(Power(((t-4)//5)-1,self.y2-9,archit_power[self.y2-9][((t-4)//5)-1],cclock.return_val()))
                        if(self.thruball == False):
                            self.speedx2 = -1 * self.speedx2
                            self.speedy2 = -1 * self.speedy2
                    elif(flss == True):
                        ...
                        if( (((((t-4)//5)+1)<= 12) and ((((t-4)//5)+1) >= 0)) and  (check_buddy(self.y2-9) and  archit[self.y2-9][((t-4)//5)]!=0) ):
                            if(archit[self.y2-9][((t-4)//5)]!=10):
                                if(archit[self.y2-9][((t-4)//5)] == -1):
                                    sscore.update_val( self.chickibum(self.y2-9,archit))
                                else:
                                    if(self.thruball==True):
                                        sscore.update_val(archit[self.y2-9][((t-4)//5)] )
                                        archit[self.y2-9][((t-4)//5)] =0
                                    else:
                                        archit[self.y2-9][((t-4)//5)] = archit[self.y2-9][((t-4)//5)] -1
                                        sscore.update_val(1)
                                    if(archit[self.y2-9][((t-4)//5)]==0 and archit_power[self.y2-9][((t-4)//5)]!=0):
                                        powers.append(Power(((t-4)//5),self.y2-9,archit_power[self.y2-9][((t-4)//5)],cclock.return_val()))
                            if(self.thruball==False):
                                self.speedx2 = -1 * self.speedx2
                                self.speedy2 = -1 * self.speedy2
                else:
                    if((self.y2 <=14 and self.y2 >= 9) and ((t>8 and t<73) and ( check_buddy(self.y2-9) and archit[self.y2-9][(t-9)//5]!=0))):
                        if(archit[self.y2-9][(t-9)//5]!=10):
                            if(archit[self.y2-9][(t-9)//5] == -1):
                                sscore.update_val( self.chickibum(self.y2-9,archit))
                            else:
                                if(self.thruball==True):
                                    sscore.update_val(archit[self.y2-9][((t-9)//5)] )
                                    archit[self.y2-9][((t-9)//5)] =0
                                else:
                                    archit[self.y2-9][(t-9)//5] = archit[self.y2-9][(t-9)//5]-1
                                    sscore.update_val(1)
                                if(archit[self.y2-9][((t-9)//5)]==0 and archit_power[self.y2-9][((t-9)//5)]!=0):
                                    powers.append(Power(((t-9)//5),self.y2-9,archit_power[self.y2-9][((t-9)//5)],cclock.return_val()))
                        if(self.thruball==False):
                            self.speedy2 = -1 * self.speedy2
                ...
                if(t%5==4 and t>9):
                    ...
                    if((self.y2 <=15 and self.y2 >= 10) and ((t>9 and t<=74) and ( check_buddy(self.y2-10) and archit[self.y2-10][((t-14)//5)]!=0))):
                        flss = True
                    if((self.y2 <=14 and self.y2 >= 9) and ((t>= 9 and t<=69) and ( check_buddy(self.y2-9) and archit[self.y2-9][(t-9)//5]!=0))):
                        fldw = True
                    ...
                    if(flss==True and fldw==True):
                        ...
                        if(( ((((t-4)//5)-1)>=0) and ((((t-4)//5)-1)<=12) ) and ( check_buddy(self.y2-9) and archit[self.y2-9][((t-4)//5)-1]!=0) ):
                            if(archit[self.y2-9][((t-4)//5)-1] !=10):
                                if(archit[self.y2-9][((t-4)//5)-1] == -1):
                                    sscore.update_val( self.chickibum(self.y2-9,archit))
                                else:
                    ...
                    if( (self.y2>=9 and self.y2<=14) and ( (t>8 and t<73) and ( check_buddy(self.y2-9) and archit[self.y2-9][(t-9)//5]!=0))):
                        if(archit[self.y2-9][(t-9)//5]!=10):
                            if(archit[self.y2-9][(t-9)//5] == -1):
                                sscore.update_val( self.chickibum(self.y2-9,archit))
                            else:
                    ...
                    if(archit[self.y2-9][(t-9)//5]!=10):
                        if(archit[self.y2-9][(t-9)//5] == -1):
                            ...
                            if(self.thruball==True):
                                ...
                                archit[self.y2-9][(t-9)//5] = archit[self.y2-9][(t-9)//5]-1
                                sscore.update_val(1)
                            if(archit[self.y2-9][((t-9)//5)]==0 and archit_power[self.y2-11][((t-9)//5)]!=0):
                                    powers.append(Power(((t-9)//5),self.y2-9,archit_power[self.y2-9][((t-9)//5)],cclock.return_val()))
                    if(self.thruball==False):
                        self.speedy2 = -1 * self.speedy2
        return True
